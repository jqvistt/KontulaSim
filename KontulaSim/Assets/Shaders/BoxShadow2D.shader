Shader "UnityCommunity/Sprites/BoxShadow2D"
{
    Properties
    {
        ...
        _SkewX ("Skew X", Range(-2, 2)) = 0
        _SkewY ("Skew Y", Range(-2, 2)) = 0
        _SkewZ ("Skew Z", Range(-2, 2)) = 0
        _ScaleWidth ("Scale Width", Range(-2, 2)) = 1
        _ScaleHeight ("Scale Height", Range(-2, 2)) = 1
    }
